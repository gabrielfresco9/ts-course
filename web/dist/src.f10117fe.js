...
function () {
  function Model(attributes, events, sync) {
    ...
    this.save = function () {
      _this.sync.save(_this.attributes.getAll()).then(function (res) {
        _this.trigger('save');
      });
    };
  }
...
function (_super) {
  ...
  User.build = function (attrs) {
    return new User(new Attributes_1.default(attrs), new Eventing_1.default(), new ApiSync_1.default('http://localhost:3000/users'));
  };

  User.buildCollection = function () {
    return new Collection_1.default('http://localhost:3000/users', User.build);
  };
...
function (_super) {
  ...
  function UserView() {
    ...
    _this.onChangeName = function () {
      ...
      _this.model.set({
        name: input === null || input === void 0 ? void 0 : input.value
      });
    };
  ...
  UserView.prototype.eventsMap = function () {
    return {
  ...
  UserView.prototype.template = function () {
...
var UserEdit_1 = __importDefault(require("./views/UserEdit"));

var collection = User_1.default.buildCollection();
collection.fetch();
setTimeout(function () {
  var root = document.getElementById("root");

  if (root) {
    var userEdit = new UserEdit_1.default(root, collection.models[0]);
    userEdit.render();
  }
}, 50);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "43773" + '/');
